...
public class ImageTargetRenderer implements GLSurfaceView.Renderer
{
    ...
    RelativeLayout mUILayout;  TextView my_text;static Handler mainActivityHandler;
                               ...
                               SampleApplicationSession session)
    {
        ...
        mUILayout = (RelativeLayout) View.inflate(activity, R.layout.camera_overlay,
                null);
        my_text=(TextView)mUILayout.findViewById(R.id.my_text);
    }
    ...
    private void renderFrame()
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            textureIndex = trackable.getName().equalsIgnoreCase("tarmac") ? 2
                : textureIndex;
            Log.i("soha tracker name", trackable.getName());
            ////////////////////soha
        DisplayText(trackable.getName());

//           my_text.setText("lol");
//            my_text.setVisibility(View.VISIBLE);;
            Log.i("sohaaaa", (String) my_text.getText());
/////////////////////////////////////////////////////////////////////////////////
